...
const comicsData: Comic[] = [
	...
	},
	{
		...
		cover: p2,
		synopsis:
			"Elle devra choisir entre son devoir et sa survie. Toutes les certitudes d' Ivy ont volé en éclats.\
	...
	},
	{
		id: "3",
		title:
			"L'Arabe Du Futur - : Moi, Fadi, le frère volé - Tome 01 (1986-1994)",
		cover: p3,
		synopsis:
	...
	},
	{
		id: "9",
		title:
			"Lucky Luke - : Les Aventures de Lucky Luke d'après Morris - Tome 11 - Un cow-boy sous Pression",
		cover: p9,
		synopsis:
	...
	},
	{
		id: "11",
		title:
			"Moi Ce Que J'aime C'est Les Monstres - : Moi, ce que j'aime, c'est les monstres 2",
		cover: p11,
		synopsis:
	...
	},
	{
		id: "15",
		title:
			"Les Vieux Fourneaux - : Les Vieux Fourneaux - Tome 8 - Graines de voyous",
		cover: p15,
		synopsis:
	...
	},
	{
		id: "17",
		title:
			"Les Rugbymen - Cet après-midi, vous avez carte bleue ! : Les Rugbymen - tome 23",
		cover: p17,
		synopsis:
	...
	const searchByLocation = (lat: number, lng: number) => {
		...
		return comicsData.filter((comic) => {
			const distance = Math.sqrt(
				(comic.location.lat - lat) ** 2 + (comic.location.lng - lng) ** 2,
			);
